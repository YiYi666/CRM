...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/linkman/linkman_addsubmit"
		method=post>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								...
								<td colspan="3">
									...
									<%--<input type="text" name="custId" style="WIDTH: 180px"/>--%></td>
							</tr>
							<TR>
								<td>联系人名称：</td>
								<td>
								<INPUT class=textbox id=lkmName" style="WIDTH: 180px" maxLength=50 name="lkmName">
								</td>
								<td>联系人性别：</td>
								<td>
							...
							<TR>
								<td>联系人办公电话 ：</td>
								<td>
								<INPUT class="textbox" id="lkmPhone" style="WIDTH: 180px" maxLength=50 name="lkmPhone">
								</td>
								<td>联系人手机 ：</td>
								<td>
